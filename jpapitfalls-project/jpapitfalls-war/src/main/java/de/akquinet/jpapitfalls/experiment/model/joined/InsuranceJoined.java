...
@NoArgsConstructor
@AllArgsConstructor
public class InsuranceJoined extends EntityBase implements Serializable {
    ...
    @Getter
    @Setter
    private EmployeeJoined employee;

    /**
     * Constructor.
     * @param carrier
     */
    public InsuranceJoined(String carrier) {
        this();
    ...
    public String toString() {
        return "InsuranceJoined(" + getFieldRepr()+ ")";
    }
