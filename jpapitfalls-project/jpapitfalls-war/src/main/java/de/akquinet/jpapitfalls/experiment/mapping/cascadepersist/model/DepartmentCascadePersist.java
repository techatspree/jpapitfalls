...
@NoArgsConstructor
@AllArgsConstructor
public class DepartmentCascadePersist extends EntityBase {
    ...
    @Getter
    @Setter
    private Set<EmployeeCascadePersist> employees;

    /**
     * Constructor.
     * @param name
     */
    public DepartmentCascadePersist(String name) {
        this.name = name;
    }

    /** */
    public void addEmployee(EmployeeCascadePersist e) {
        if (employees == null) {
            employees = new HashSet<EmployeeCascadePersist>();
        }
        employees.add(e);
    }
    ...
    public String toString() {
        return "DepartmentCascadePersist(" + getFieldRepr()+ ")";
    }
