...
@NoArgsConstructor
@AllArgsConstructor
public abstract class EmployeeJoined extends PersonJoined {
    ...
    @Getter
    @Setter
    private InsuranceJoined insurance;

    /** */
    public EmployeeJoined(String firstname, String lastname, double weeklyHours) {
