...
@NoArgsConstructor
@AllArgsConstructor
public class ExternalEmployeeSingleTable extends EmployeeSingleTable {
    ...
    /** */
    public ExternalEmployeeSingleTable(String firstname, String lastname, double weeklyHours, String company) {
