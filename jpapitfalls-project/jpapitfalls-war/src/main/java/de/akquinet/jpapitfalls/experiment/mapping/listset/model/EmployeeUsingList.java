...
@NoArgsConstructor
@AllArgsConstructor
public class EmployeeUsingList extends EntityBase implements Serializable {
    ...
    @Getter
    @Setter
    private DepartmentUsingList department;

    /** */
    public EmployeeUsingList(String firstname, String lastname) {
    ...
    public String toString() {
        return "EmployeeUsingList(" + getFieldRepr() + ")";
    }
