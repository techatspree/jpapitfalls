...
@NoArgsConstructor
@AllArgsConstructor
public class EmployeeNonCascade extends EntityBase implements Serializable {
    ...
    @Getter
    @Setter
    private DepartmentNonCascade department;

    /** */
    public EmployeeNonCascade(String firstname, String lastname) {
        this();
    ...
    public String toString() {
        return "EmployeeNonCascade(" + getFieldRepr() + ")";
    }
