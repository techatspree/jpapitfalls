...
@NoArgsConstructor
@AllArgsConstructor
public abstract class EmployeeTablePerClass extends PersonTablePerClass {
    ...
    @Getter
    @Setter
    private InsuranceTablePerClass insurance;

    /** */
    public EmployeeTablePerClass(String firstname, String lastname, double weeklyHours) {
