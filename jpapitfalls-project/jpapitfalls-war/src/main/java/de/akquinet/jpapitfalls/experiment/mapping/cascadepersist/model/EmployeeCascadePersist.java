...
@NoArgsConstructor
@AllArgsConstructor
public class EmployeeCascadePersist extends EntityBase implements Serializable {
    ...
    @Getter
    @Setter
    private DepartmentCascadePersist department;

    /** */
    public EmployeeCascadePersist(String firstname, String lastname) {
        this();
    ...
    public String toString() {
        return "EmployeeCascadePersist(" + getFieldRepr() + ")";
    }
