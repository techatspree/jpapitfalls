...
@NoArgsConstructor
@AllArgsConstructor
public class InsuranceTablePerClass extends EntityBase implements Serializable {
    ...
    @Getter
    @Setter
    private EmployeeTablePerClass employee;

    /**
     * Constructor.
     * @param carrier
     */
    public InsuranceTablePerClass(String carrier) {
        this();
    ...
    public String toString() {
        return "InsuranceTablePerClass(" + getFieldRepr()+ ")";
    }
