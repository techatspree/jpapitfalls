...
@NoArgsConstructor
@AllArgsConstructor
public class ExternalEmployeeJoined extends EmployeeJoined {
    ...
    /** */
    public ExternalEmployeeJoined(String firstname, String lastname, double weeklyHours, String company) {
